...
- Fetches a dictionary of categories in which the keys are the ids and the value is the corresponding string of category
...
POST '/quizzes'
- Add a quiz to and then assign it by category id
